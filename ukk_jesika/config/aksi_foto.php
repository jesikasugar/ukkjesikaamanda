...
if (isset($_POST['edit'])) {
	...
	if ($foto == null) {
		...
		deskripsifoto='$deskripsifoto', tanggalunggah='$tanggalunggah', albumid='
		$albumid' where fotoid='$fotoid' ");
	}else {
		...
		move_uploaded_file($tmp, $lokasi.$namafoto);
		$sql = mysqli_query($koneksi, "UPDATE foto SET judulfoto='$judulfoto',
		deskripsifoto='$deskripsifoto', tanggalunggah='$tanggalunggah', lokasifile='
		$namafoto',albumid='$albumid' where fotoid='$fotoid' ");
	}
	echo "<script>
